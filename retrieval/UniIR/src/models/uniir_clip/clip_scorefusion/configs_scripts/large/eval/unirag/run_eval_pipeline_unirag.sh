...
# Initialize Conda
source /home/du/anaconda3/etc/profile.d/conda.sh # <--- Change this to the path of your conda.sh

# Path to the codebase and config file
SRC="/home/du/pan1/new_knowledge/real_new/mmrag/UniIR/src"  # Absolute path to codebse /UniIR/src # <--- Change this to the path of your UniIR/src
